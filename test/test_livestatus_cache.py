...
Stats: state = 3"""
        ...
        print("after %s" % afterresponse)
        self.assertTrue(beforeresponse != afterresponse)
        repeatedresponse, keepalive = self.livestatus_broker.livestatus.handle_request(request)
        print("repeated %s" % repeatedresponse)
